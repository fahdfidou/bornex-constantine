...
const MaintenancePage = () => {
  ...
  return (
    <div className="relative min-h-screen">
      {/* Background avec images de maintenance */}
      <div className="absolute inset-0 opacity-5 pointer-events-none">
        <div className="absolute top-20 left-20 w-44 h-44 bg-gradient-to-br from-orange-400 to-red-500 rounded-full blur-2xl"></div>
        <div className="absolute top-40 right-10 w-40 h-40 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full blur-xl"></div>
        <div className="absolute bottom-20 left-40 w-36 h-36 bg-gradient-to-br from-red-400 to-pink-500 rounded-full blur-2xl"></div>
        
        {/* Icônes de maintenance en arrière-plan */}
        <div className="absolute top-1/4 left-1/6 opacity-8">
          <Wrench className="w-32 h-32 text-orange-500" />
        </div>
        ...
        <Tabs defaultValue="tickets" className="space-y-4">
          ...
          <TabsContent value="tickets" className="space-y-4">
            {activeTickets.map((ticket) => (
              <Card key={ticket.id} className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-gray-200 dark:border-gray-700 transition-colors duration-200">
                <CardHeader>
          ...
          <TabsContent value="history" className="space-y-4">
            {maintenanceHistory.map((item, index) => (
              <Card key={index} className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-gray-200 dark:border-gray-700 transition-colors duration-200">
                <CardContent className="p-6">
                  <div className="flex justify-between items-center">
                    <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 border dark:border-gray-600 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium dark:text-white">{t('stations.centreville')}</p>
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                  ...
                  <div className="flex items-center justify-between p-4 border dark:border-gray-600 rounded-lg">
                    <div className="flex items-center space-x-3">
                      <Calendar className="h-5 w-5 text-green-600 dark:text-green-400" />
                      <div>
                        <p className="font-medium dark:text-white">{t('stations.university')}</p>
                        <p className="text-sm text-gray-500 dark:text-gray-400">
