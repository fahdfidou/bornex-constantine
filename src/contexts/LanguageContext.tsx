...
const translations = {
  fr: {
    ...
    'myStation.setDuration': 'Durée d\'arrêt',
    'myStation.setSpecificTime': 'Heure d\'arrêt',
    'myStation.schedule': 'Programmer',
    'myStation.scheduledOff': 'Arrêt programmé',

    // AI Optimization
    'ai.title': 'Optimisation IA',
    'ai.subtitle': 'Optimisez l\'efficacité de vos bornes',
    'ai.status': 'Statut de l\'IA',
    'ai.efficiency': 'Efficacité actuelle',
    'ai.optimal': 'Optimal',
    'ai.optimizing': 'Optimisation en cours...',
    'ai.startOptimization': 'Démarrer l\'optimisation',
    'ai.suggestions': 'Suggestions d\'amélioration',
    'ai.energyStats': 'Statistiques énergétiques',
    'ai.kwhSaved': 'kWh économisés',
    'ai.dzaSaved': 'DZA économisés',
    'ai.suggestion.schedule': 'Optimiser les horaires',
    'ai.suggestion.scheduleDesc': 'Programmer les charges aux heures creuses',
    'ai.suggestion.battery': 'Gestion de batterie',
    'ai.suggestion.batteryDesc': 'Améliorer la durée de vie des batteries',
    'ai.suggestion.temperature': 'Contrôle thermique',
    'ai.suggestion.temperatureDesc': 'Optimiser la température de fonctionnement',

    // Issue Reporting
    'issue.powerProblem': 'Problème d\'alimentation',
    'issue.overheating': 'Surchauffe',
    'issue.chargingSlow': 'Charge lente',
    'issue.connectorProblem': 'Problème de connecteur',
    'issue.displayError': 'Erreur d\'affichage',
    'issue.unusualNoise': 'Bruit inhabituel',
    'issue.connectionProblem': 'Problème de connexion',
    'issue.other': 'Autre',
    'issue.commonProblems': 'Problèmes courants',
    'issue.additionalDetails': 'Détails supplémentaires',
    'issue.describeIssue': 'Décrivez le problème en détail...',
    'issue.sendReport': 'Envoyer le rapport',
    'issue.selectOrDescribe': 'Sélection requise',
    'issue.selectOrDescribeDesc': 'Veuillez sélectionner un problème ou ajouter une description',
    'issue.reportSent': 'Rapport envoyé',
    'issue.reportSentDesc': 'Votre rapport a été envoyé avec succès',
  ...
  ar: {
    ...
    'myStation.setDuration': 'مدة الإيقاف',
    'myStation.setSpecificTime': 'وقت الإيقاف',
    'myStation.schedule': 'برمجة',
    'myStation.scheduledOff': 'الإيقاف المبرمج',

    // AI Optimization
    'ai.title': 'تحسين الذكاء الاصطناعي',
    'ai.subtitle': 'تحسين كفاءة محطاتك',
    'ai.status': 'حالة الذكاء الاصطناعي',
    'ai.efficiency': 'الكفاءة الحالية',
    'ai.optimal': 'مثالي',
    'ai.optimizing': 'جاري التحسين...',
    'ai.startOptimization': 'بدء التحسين',
    'ai.suggestions': 'اقتراحات التحسين',
    'ai.energyStats': 'إحصائيات الطاقة',
    'ai.kwhSaved': 'كيلو واط ساعة محفوظة',
    'ai.dzaSaved': 'دينار جزائري محفوظ',
    'ai.suggestion.schedule': 'تحسين الجدولة',
    'ai.suggestion.scheduleDesc': 'برمجة الشحن في أوقات الذروة المنخفضة',
    'ai.suggestion.battery': 'إدارة البطارية',
    'ai.suggestion.batteryDesc': 'تحسين عمر البطاريات',
    'ai.suggestion.temperature': 'التحكم الحراري',
    'ai.suggestion.temperatureDesc': 'تحسين درجة حرارة التشغيل',

    // Issue Reporting
    'issue.powerProblem': 'مشكلة في الطاقة',
    'issue.overheating': 'سخونة زائدة',
    'issue.chargingSlow': 'شحن بطيء',
    'issue.connectorProblem': 'مشكلة في الموصل',
    'issue.displayError': 'خطأ في الشاشة',
    'issue.unusualNoise': 'ضوضاء غير عادية',
    'issue.connectionProblem': 'مشكلة في الاتصال',
    'issue.other': 'أخرى',
    'issue.commonProblems': 'المشاكل الشائعة',
    'issue.additionalDetails': 'تفاصيل إضافية',
    'issue.describeIssue': 'اوصف المشكلة بالتفصيل...',
    'issue.sendReport': 'إرسال التقرير',
    'issue.selectOrDescribe': 'مطلوب تحديد',
    'issue.selectOrDescribeDesc': 'يرجى تحديد مشكلة أو إضافة وصف',
    'issue.reportSent': 'تم إرسال التقرير',
    'issue.reportSentDesc': 'تم إرسال تقريرك بنجاح',
  ...
  en: {
    ...
    'myStation.setDuration': 'Set Duration',
    'myStation.setSpecificTime': 'Set Specific Time',
    'myStation.schedule': 'Schedule',
    'myStation.scheduledOff': 'Scheduled Off',

    // AI Optimization
    'ai.title': 'AI Optimization',
    'ai.subtitle': 'Optimize your stations efficiency',
    'ai.status': 'AI Status',
    'ai.efficiency': 'Current Efficiency',
    'ai.optimal': 'Optimal',
    'ai.optimizing': 'Optimizing...',
    'ai.startOptimization': 'Start Optimization',
    'ai.suggestions': 'Improvement Suggestions',
    'ai.energyStats': 'Energy Statistics',
    'ai.kwhSaved': 'kWh Saved',
    'ai.dzaSaved': 'DZA Saved',
    'ai.suggestion.schedule': 'Optimize Scheduling',
    'ai.suggestion.scheduleDesc': 'Schedule charging during off-peak hours',
    'ai.suggestion.battery': 'Battery Management',
    'ai.suggestion.batteryDesc': 'Improve battery lifespan',
    'ai.suggestion.temperature': 'Thermal Control',
    'ai.suggestion.temperatureDesc': 'Optimize operating temperature',

    // Issue Reporting
    'issue.powerProblem': 'Power Problem',
    'issue.overheating': 'Overheating',
    'issue.chargingSlow': 'Slow Charging',
    'issue.connectorProblem': 'Connector Problem',
    'issue.displayError': 'Display Error',
    'issue.unusualNoise': 'Unusual Noise',
    'issue.connectionProblem': 'Connection Problem',
    'issue.other': 'Other',
    'issue.commonProblems': 'Common Problems',
    'issue.additionalDetails': 'Additional Details',
    'issue.describeIssue': 'Describe the issue in detail...',
    'issue.sendReport': 'Send Report',
    'issue.selectOrDescribe': 'Selection Required',
    'issue.selectOrDescribeDesc': 'Please select a problem or add a description',
    'issue.reportSent': 'Report Sent',
    'issue.reportSentDesc': 'Your report has been sent successfully',
